        ...
        <Row xs={1} md={2} className="h-100">
          <Col className="my-auto">
            <div>
              ...
              <h1 className="color-name-blue text-boldest">I'm Nesa William.</h1>
            ...
            <Button className="bg-custom-blue font-weight-bold shadow-sm border-0 resume-btn" onClick={() => window.open('/static/Nesa William.pdf', '_blank')}>View Resume</Button>
          </Col>
