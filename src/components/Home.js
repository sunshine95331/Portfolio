        ...
        <Row xs={1} md={2} className="h-100">
          <Col className="my-auto">
            <div>
              ...
              <h1 className="color-name-blue text-boldest">I'm Prodan Markovic.</h1>
              <span className="color-custom-grey h4">
                <Typist className="TypistExample-message" cursor={{ show: false }}>
                  <span>I'm a </span><span className="font-weight-bold">
                    ...
                    <Typist.Backspace count={20} delay={3500} /> Senior</span> Java Developer </Typist></span><br />
            ...
            <div className="d-flex my-4">
              ...
              <Button variant="" className="color-custom-blue p-0 mr-3 border-0" aria-label="linkedin" onClick={() => window.open('https://www.linkedin.com/in/nesa-william-3162ba31a/', '_blank')}><FontAwesomeIcon size="2x" icon={faLinkedin} /></Button>
            </div>
            <Button className="bg-custom-blue font-weight-bold shadow-sm border-0 resume-btn" onClick={() => window.open('/static/Prodan Markovic.pdf', '_blank')}>View Resume</Button>
          </Col>
